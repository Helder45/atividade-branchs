    ...
    static async createAnUser() {
        await inquirer
            ...
            if (answers.userName === "" ||
                ...
                answers === undefined) {
                throw new CamposVazios(chalk.red("É preciso preencher corretamente todos os campos!"));
            }
            else {
                if (answers.userPassword === answers.userPasswordConfirm) {
                    ...
                    throw new SenhasDiferentes(chalk.red("As senhas inseridas devem ser iguais."));
                }
            }
        })
            .catch((error) => {
            ...
            if (error.code === "P2002") {
                console.log(chalk.red("Erro: Este e-mail já está cadastrado no sistema!"));
            }
